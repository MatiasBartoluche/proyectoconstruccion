...
<html>
    <head>
        ...
        <script src="${pageContext.request.contextPath}/js/nueva_sociedad.js"></script>
        <title>Home</title>
    </head>
    <body>
    ...
    <section class="home">
        ...
        <article id="nuevaSociedad">
            ...
            <textarea id="razonSocialSociedad" placeholder="Razon social"></textarea>
            
            <h2>Datos de contacto</h2>
            
            <div id="contenedorDireccionSociedad">
                <label>Calle</label>
                <input type="text" id="calleSociedad" placeholder="Calle">
                <label>Altura</label>
                <input type="number" id="alturaSociedad" placeholder="Numero">
                <label>Piso-Dpto</label>
                <input type="text" id="pisoSociedad" placeholder="Piso">
                <label>Localidad</label>
                <input type="text" id="localidadSociedad" placeholder="Localidad">
                <label>Telefono</label>
                <input type="text" id="telefonoSociedad" placeholder="1123456789">
                <label>Correo electronico</label>
                <input type="email" id="mailSociedad" placeholder="correo@email.com">
            </div>
            <button id="guardarNuevaSociedad">Guardar</button>
        </article>
